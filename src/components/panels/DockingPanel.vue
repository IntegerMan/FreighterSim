...
<template>
  <div class="docking-panel">
      ...
      <!-- Undocked State -->
      <template v-else>
        <div class="docking-panel__status" :class="`docking-panel__status--${statusClass}`">
          {{ dockingStatus }}
        </div>
        ...
        <template v-if="nearestStation">
          ...
          <div v-if="isInDockingRange" class="docking-panel__speed-check">
            ...
            >
              ...
              <span v-if="shipStore.speed > 5" class="docking-panel__speed-warning">
                (MAX 5)
              </span>
            </span>
          </div>
